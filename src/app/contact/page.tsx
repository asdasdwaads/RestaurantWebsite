      ...
      <div className="relative flex flex-wrap-reverse justify-center gap-5 py-10 bg-[#00000091]">
        <div className="w-[300px] smartphone:w-[400px] y-tablet:w-[500px] h-[60vh] smartphone:h-[80vh]">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d675.4347165632298!2d15.094453616625984!3d47.378014935141636!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4771df8f52936ca5%3A0xec94f616321ecf92!2sCharm%20Thai%20Restaurant!5e0!3m2!1sen!2sat!4v1759858533840!5m2!1sen!2sat"
          />
        </div>
        ...
        <div className="w-[300px] smartphone:w-[400px] y-tablet:w-[500px]">
          <ContactContainer
            ...
            styles={{
              ...
              children: "grid w-full gap-5 w-full max-w-full overflow-x-hidden overflow-hidden",
            }}
            ...
            {ENABLE_TURNSTILE && (
              <>
                ...
                <div 
                  ...
                  ref={widgetRootRef} 
                  className="cf-turnstile m-auto w-full max-w-full rounded-[10px] overflow-hidden flex justify-center"
                />
              </>
            )}
